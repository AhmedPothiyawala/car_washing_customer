         ...
         () {
            return homeController.isLoding2.value?
              ...
              child: SingleChildScrollView(
                padding: EdgeInsets.only(bottom: navBarHeight>0?navBarHeight:0),
                ...
                child: Column(
                  ...
                  children: [
                                ...
                                child: Container(
                                  ...
                                  decoration:  BoxDecoration(
                                      image: DecorationImage(
                                          image: NetworkImage(homeController.bookingDetail.value.bookings!.carClassImage.toString()),
                                          fit: BoxFit.fill)),
                                ),
                              ),
                              Container(
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            Text(
                              homeController.bookingDetail.value.bookings!.carClassTitleEn.toString(),
                              style: sfProMediumTextstyle.copyWith(
                                  color: AppColors.blackColor),
                            ),
                            const SizedBox(
                    ...
                    Row(
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            Text(
                              homeController.bookingDetail.value.bookings!.service.toString(),
                              style: sfProRegularTextstyle.copyWith(
                                  fontSize: 14, color: AppColors.blackColor),
                            ),
                            Text(
                        ...
                        Column(
                          ...
                          children: [
                            Text(
                              homeController.bookingDetail.value.bookings!.totalDistance.toString(),
                              style: sfProRegularTextstyle.copyWith(
                                  fontSize: 14, color: AppColors.blackColor),
                            ),
                            Text(
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: ListView.separated(
                                  ...
                                  return  Text(
                                     homeController.dropController[index].text,
                                      style: sfProMediumTextstyle.copyWith(
                                          color: AppColors.blackColor),
                                    );
                    ...
                    Text(
                      homeController.bookingDetail.value.bookings!.customerName.toString(),
                      style: sfProRegularTextstyle.copyWith(
                          fontSize: 14, color: AppColors.blackColor),
                    ),
                    const SizedBox(
                      ...
                      children: [
                        Column(
                            ...
                            children: [
                              ...
                              Text(
                                homeController.bookingDetail.value.bookings!.billingCompanyName.toString(),
                                style: sfProRegularTextstyle.copyWith(
                                    fontSize: 14, color: AppColors.blackColor),
                              ),
                            ]),
                      ...
                      children: [
                        Column(
                            ...
                            children: [
                              ...
                              SizedBox(
                                  width: kWidth * 0.4,
                                  child: Text(
                                    homeController.bookingDetail.value.bookings!.customerEmail.toString(),
                                    style: sfProRegularTextstyle.copyWith(
                                        fontSize: 14, color: AppColors.blackColor),
                                  )),
                            ]),
                        ...
                        Column(
                            ...
                            children: [
                              ...
                              Text(
                                homeController.bookingDetail.value.bookings!.customerPhone.toString(),
                                style: sfProRegularTextstyle.copyWith(
                                    fontSize: 14, color: AppColors.blackColor),
                              ),
                            ]),
                    ...
                    SizedBox(
                        width: kWidth * 0.9,
                        child: Text(
                          homeController.bookingDetail.value.bookings!.customerRemarks.toString(),
                          style: sfProRegularTextstyle.copyWith(
                              fontSize: 14, color: AppColors.blackColor),
                        )),
                    const SizedBox(
                    ...
                    Text(
                      homeController.bookingDetail.value.bookings!.dispatcherName.toString(),
                      style: sfProRegularTextstyle.copyWith(
                          fontSize: 14, color: AppColors.blackColor),
                    ),
                    const SizedBox(
                      ...
                      children: [
                        Column(
                            ...
                            children: [
                              ...
                              Text(
                                homeController.bookingDetail.value.bookings!.dispatcherPhone.toString(),
                                style: sfProRegularTextstyle.copyWith(
                                    fontSize: 14, color: AppColors.blackColor),
                              ),
                            ]),
                        Column(
                            ...
                            children: [
                              ...
                              Text(
                                homeController.bookingDetail.value.bookings!.dispatcherOrderNumber.toString(),
                                style: sfProRegularTextstyle.copyWith(
                                    fontSize: 14, color: AppColors.blackColor),
                              ),
                            ]),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                          double.tryParse(
                            homeController.bookingDetail.value.bookings!.baseRate.toString(),
                          )!.toStringAsFixed(2),
                          style: sfProRegularTextstyle.copyWith(
                              fontSize: 16, color: AppColors.blackColor),
                        ),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                          double.tryParse(
                            homeController.bookingDetail.value.bookings!.ourFees.toString(),
                          )!.toStringAsFixed(2),
                          style: sfProRegularTextstyle.copyWith(
                              fontSize: 16, color: AppColors.blackColor),
                        ),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                          double.tryParse(
      (                         double.parse(homeController.bookingDetail.value.bookings!.baseRate.toString())+ double.parse(homeController.bookingDetail.value.bookings!.ourFees.toString()) ).toString(),
                          )!.toStringAsFixed(2),
                          style: sfProRegularTextstyle.copyWith(
                              fontSize: 16, color: AppColors.blackColor),
                        ),
