...
import 'package:go_burble_new/app/modules/pickmeup/views/select_rider.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    const Spacer(),
                    Center(child: Text("location".tr,style: sfProMediumTextstyle.copyWith(fontSize: 12,color: AppColors.blackColor),)),
      ...
      body: Container(
        ...
        width: kWidth,
        decoration: const BoxDecoration(
          image: DecorationImage(image: AssetImage(AppImages.mapImage),fit: BoxFit.fill)
        ),
      ),
              ...
              children: [
                ...
                Align(
                   alignment: Alignment.center,
                    child: Text("bookPickUpMyCar".tr,textAlign: TextAlign.center, style: sfProSemiBoldTextstyle.copyWith(fontSize: 18),)),
                const SizedBox(height: 10,),
                const Divider(
                  thickness: 1,
                  ...
                  children: [
                    ...
                    Center(
                      child: CustomDropDownFormField(
                        height: 50,
                        hintStyle: sfProMediumTextstyle.copyWith(fontSize: 12,color: AppColors.blackColor),
                ...
                Row(
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("currentAddress".tr,style: sfProRegularTextstyle.copyWith(color: AppColors.greyShadeFour),),
                        const SizedBox(height: 10,),
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Container(
                                ...
                                width: 11,
                                decoration: const BoxDecoration(
                                    image: DecorationImage(image: AssetImage(AppImages.arrowSwapIcon))
                                ),
                              ),
                            )
                          ],
                        ...
                        const SizedBox(height: 10,),
                        Text("transferType".tr,style: sfProRegularTextstyle.copyWith(color: AppColors.greyShadeFour),),
                        const SizedBox(height: 10,),
