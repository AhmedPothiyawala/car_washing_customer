            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Obx(
                  () {
                      return Text(homeController.currentAddress.value!=null?" ${homeController.currentAddress.value!.administrativeArea}, ${homeController.currentAddress.value!.country}":"",
                  ...
                  children: [
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(homeController.homeData.value.configuration!.bannerDetails!.name.toString(),
                                  style: sfProSemiBoldTextstyle.copyWith(
                            ...
                            Padding(
                              ...
                              child: SizedBox(
                                  width: kWidth * 0.6,
                                  child: Text(homeController.homeData.value.configuration!.bannerDetails!.description.toString(),
                                      style: sfProRegularTextstyle.copyWith(
                                          color: AppColors.appBackgroundColor,
                                          fontSize: 16))),
                            ),
                            Row(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Center(
                                      child: Text(homeController.homeData.value.configuration!.bannerDetails!.buttonText.toString(),
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Text(homeController.homeData.value.configuration!.servicesList![0].name.toString(),
                                        style: sfProSemiBoldTextstyle.copyWith(
                                            color: AppColors.blackColor,
                                            fontSize: 16))
                                  ],
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Text(homeController.homeData.value.configuration!.servicesList![1].name.toString(),
                                        style: sfProSemiBoldTextstyle.copyWith(
                                            color: AppColors.blackColor,
                                            fontSize: 16))
                                  ],
                    ...
                    Padding(
                        ...
                        child: SingleChildScrollView(
                          scrollDirection: Axis.horizontal,
                          child: Wrap(
                            children: List.generate(homeController.homeData.value.configuration!.offersList!.length, (val) {
                              return Padding(
                                        ...
                                        children: [
                                          ...
                                          SizedBox(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Text(homeController.homeData.value.configuration!.offersList![val].name.toString(),
                                                    style:
                                          ...
                                          SizedBox(
                                            ...
                                            child: Column(
                                              ...
                                              crossAxisAlignment:
                                                  CrossAxisAlignment.start,
                                              children: [
                                                Text(homeController.homeData.value.configuration!.offersList![val].description.toString(),
                                          ...
                                          Container(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                Text(homeController.homeData.value.configuration!.offersList![val].buttonText.toString(),
                                                    style: sfProRegularTextstyle
                                                        .copyWith(
                                                            color:
                                                                AppColors.blackColor,
