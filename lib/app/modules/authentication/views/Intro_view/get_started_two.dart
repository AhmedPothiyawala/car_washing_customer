          ...
          children: [
            ...
            SizedBox(
              ...
              child: Padding(
                ...
                child: Text(
                  "addToSetYourFavouriteDriver".tr,maxLines: 4,
              ...
              child: Row(
                ...
                children: [
                  Column(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      SvgPicture.asset(AppImages.getStartedNavigationTwo,
                        height: 10,width: 56,),
                      const SizedBox(height: 10,),
                      InkWell(
                        onTap: (){
                  ...
                  InkWell(
                    onTap: () {
                      Get.toNamed(Routes.GET_STARTED_THREE);
                    },
                    child: Container(
                      height: 58,
                      width: 58,
                      decoration: const BoxDecoration(
                          image: DecorationImage(image: AssetImage(AppImages
                              .getStartedTwoArrowImage),fit: BoxFit.fill)
                      ),
                    ),
                  )
                ],
